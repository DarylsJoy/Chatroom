...
import {
  socket, fetchUsers, fetchGroups, signout, updateProfile, changeTarget,
  ...
  toggleReceive, toggleSound, toggleNotice, toggleScreen
} from '../../actions';
...
class Chat extends React.PureComponent {
  ...
  requestFullScreen() {
    ...
    de.requestFullscreen = de.requestFullscreen || de.mozRequestFullScreen || de.webkitRequestFullScreen;
