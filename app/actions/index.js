...
export const changeUser = makeActionCreator(actionTypes.CHANGE_USER, 'user'); // 改变用户
export const changeTarget = makeActionCreator(actionTypes.CHANGE_TARGET, 'target'); // 改变消息对象
export const initUsers = makeActionCreator(actionTypes.INIT_USERS, 'users'); // 初始化用户列表
export const addUser = makeActionCreator(actionTypes.ADD_USER, 'user'); // 添加用户
export const removeUser = makeActionCreator(actionTypes.REMOVE_USER, 'username'); // 删除用户
export const updateUser = makeActionCreator(actionTypes.UPDATE_USER, 'user'); // 修改用户资料
export const initGroups = makeActionCreator(actionTypes.INIT_GROUPS, 'groups'); // 初始化群组列表
export const addGroup = makeActionCreator(actionTypes.ADD_GROUP, 'group'); // 添加群组
export const addGroupMsg = makeActionCreator(actionTypes.ADD_GROUP_MSG, 'msg'); // 添加群组消息
export const addUserMsg = makeActionCreator(actionTypes.ADD_USER_MSG, 'msg'); // 添加用户消息
export const addSelfMsg = makeActionCreator(actionTypes.ADD_SELF_MSG, 'msg'); // 添加本人消息
export const changeWarning = makeActionCreator(actionTypes.CHANGE_WARNING, 'warning'); // 改变警告
export const changeModal = makeActionCreator(actionTypes.CHANGE_MODAL, 'modal'); // 改变模态框
export const toggleReceive = makeActionCreator(actionTypes.TOGGLE_RECEIVE); // 切换接收私聊
export const toggleSound = makeActionCreator(actionTypes.TOGGLE_SOUND); // 切换声音提醒
export const toggleNotice = makeActionCreator(actionTypes.TOGGLE_NOTICE); // 切换桌面提醒
export const toggleScreen = makeActionCreator(actionTypes.TOGGLE_SCREEN); // 切换全屏显示
